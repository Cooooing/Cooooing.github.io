...
最近刷到很多程序员失业、转行以及面试不顺的帖子，包括我自己找工作也是非常不顺利。
有时候会想，作为程序员的职业生涯会不会已经结束了。
AI 盛行的当下，写代码完成一个功能实现一个效果已经不太会让人兴奋起来了，很多时候都只是追求一个结果，但过程真的不重要吗？
我也不知道

我也不知道为什么，我想把英语捡回来，希望这次不像之前说“我要学前端”，学了那么多次之后也只是把前端完全交给 AI 去写。
从新概念开始吧，计划是 18 个月，目标是雅思。很模糊了，先开始，其他的后面再说吧。
