...
| **字面量**  | 普通字符            | 未被识别为时间占位符的字符按字面量输出 | `"UTC 2006"` → `UTC 2025`              | 单引号不是转义语法，只是普通字符 |
...
| **RFC1123**     | `Mon, 02 Jan 2006 15:04:05 MST`       | `Sat, 06 Sep 2025 11:45:05 SGT`       | 邮件/HTTP 历史格式      | HTTP 响应头建议使用 GMT 格式     |
| **RFC1123Z**    | `Mon, 02 Jan 2006 15:04:05 -0700`     | `Sat, 06 Sep 2025 11:45:05 +0800`     | RFC1123 数值时区版     | 不符合 HTTP-date 对 GMT 的要求 |
