...
![](https://cooooing.github.io/images/设计模式/Employee.jpg)

> 中括号中的内容表示是可选的
> 也有将类型放在变量名前面，返回值类型放在方法名前面

比如：
![](https://cooooing.github.io/images/设计模式/demo.png)
...
1. 单向关联
   ![](https://cooooing.github.io/images/设计模式/customer_address.png)
在UML类图中单向关联用一个带箭头的实线表示。
2. 双向关联
   ![](https://cooooing.github.io/images/设计模式/customer_product.png)
在UML类图中，双向关联用一个不带箭头的直线表示。
3. 自关联
   ![](https://cooooing.github.io/images/设计模式/node.png)
...
![](https://cooooing.github.io/images/设计模式/image-20191229173422328.png)
...
![](https://cooooing.github.io/images/设计模式/image-20191229173455149.png)
...
![](https://cooooing.github.io/images/设计模式/image-20191229173518926.png)
...
![](https://cooooing.github.io/images/设计模式/image-20191229173539838.png)
...
![](https://cooooing.github.io/images/设计模式/image-20191229173554296.png)
...
![](https://cooooing.github.io/images/设计模式/open-close.png)
...
![](https://cooooing.github.io/images/设计模式/正方形不是长方形.png)
但当需要增加长方形的宽度直至大于长度时（一些新的需要），正方形的代码便会出现问题。
即正方形与长方形的继承关系违反了里氏替换原则，他们之间的继承关系不成立，正方形不是长方形。
改进：
正方形和长方形都继承四边形的接口
![](https://cooooing.github.io/images/设计模式/正方形不是长方形改进.png)
...
像下图这样设计会导致**配件无法更换**。
![](https://cooooing.github.io/images/设计模式/依赖倒转原则.png)
改进：
将需要的配件进行抽象。让电脑类依赖于各个配件的抽象，而不是直接依赖于各个配件的实现。
![](https://cooooing.github.io/images/设计模式/依赖倒转原则改进.png)
...
![](https://cooooing.github.io/images/设计模式/接口隔离原则.png)
但当我们需要创建另一个安全门，只具有防火和防水功能时。就无法实现了。
改进的方法就是：将防盗、防火、防水提取成的一个接口拆分成三个接口，以便客户只取需要的。
![](https://cooooing.github.io/images/设计模式/接口隔离原则1.png)
...
![](https://cooooing.github.io/images/设计模式/迪米特法则.png)
...
![](https://cooooing.github.io/images/设计模式/合成复用原则.png)
如果同时考虑这两种分类，其组合就很多。
所以可以将颜色以接口的方式实现，汽车类实现颜色接口，在创建汽车时传入颜色对象。可以减少很多子类的产生。
![](https://cooooing.github.io/images/设计模式/合成复用原则1.png)
...
![](https://cooooing.github.io/images/设计模式/工厂设计模式引入.png)
...
##### 实现
对咖啡店点餐系统的改进：
![](https://cooooing.github.io/images/设计模式/简单工厂模式.png)
...
对咖啡店点餐系统的改进：
![](https://cooooing.github.io/images/设计模式/工厂方法模式.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200401214509176.png)
...
所以这个案例可以使用抽象工厂模式实现。
![](https://cooooing.github.io/images/设计模式/抽象工厂模式.png)
...
![](https://cooooing.github.io/images/设计模式/jdk源码解析.png)
...
![](https://cooooing.github.io/images/设计模式/原型模式.png)
...
![](https://cooooing.github.io/images/设计模式/原型模式1.png)
...
![](https://cooooing.github.io/images/设计模式/建造者模式.png)
...
![](https://cooooing.github.io/images/设计模式/建造者模式1.png)
...
![](https://cooooing.github.io/images/设计模式/静态代理.png)
...
![](https://cooooing.github.io/images/设计模式/转接头.png)
...
类图如下：
![](https://cooooing.github.io/images/设计模式/适配器模式.png)
...
![](https://cooooing.github.io/images/设计模式/对象适配器模式.png)
...
![](https://cooooing.github.io/images/设计模式/适配器模式-jdk源码解析.png)
...
![](https://cooooing.github.io/images/设计模式/装饰者模式-使用前.png)
...
类图如下：
![](https://cooooing.github.io/images/设计模式/装饰者模式.png)
...
![](https://cooooing.github.io/images/设计模式/装饰者模式-jdk源码.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200207194617620.png)
...
类图如下：
![](https://cooooing.github.io/images/设计模式/桥接模式.png)
...
![](https://cooooing.github.io/images/设计模式/外观模式引入.jpg)
...
![](https://cooooing.github.io/images/设计模式/外观模式.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200207234545691.png)

RequestFacade类就使用了外观模式。先看结构图：

![](https://cooooing.github.io/images/设计模式/外观模式-jdk源码解析.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200208180417291.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200208182322313.png)

要实现该案例，我们先画出类图：

![](https://cooooing.github.io/images/设计模式/组合模式.png)
...
![](https://cooooing.github.io/images/设计模式/组合模式-安全性.png)
...
![](https://cooooing.github.io/images/设计模式/俄罗斯方块.jpeg)

先来看类图：

![](https://cooooing.github.io/images/设计模式/享元模式.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200208212930857.png)
...
![](https://cooooing.github.io/images/设计模式/模板方法模式.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200210143039168.png)

作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择Idea进行开发，也可以使用eclipse进行开发，也可以使用其他的一些开发工具。

![](https://cooooing.github.io/images/设计模式/image-20200210144457478.png)
...
![](https://cooooing.github.io/images/设计模式/策略模式.png)
...
这里在调用Arrays的sort方法时，第二个参数传递的是Comparator接口的子实现类对象。所以Comparator充当的是抽象策略角色，而具体的子实现类充当的是具体策略角色。环境角色类（Arrays）应该持有抽象策略的引用来调用。
那么，Arrays类的sort方法到底有没有使用Comparator子实现类中的 `compare()` 方法？查看TimSort类的 `sort()` 方法，代码如下：
...
可以看见，只用了compare方法，所以在调用Arrays.sort方法只传具体compare重写方法的类对象就行，这也是Comparator接口中必须要子类实现的一个方法。
...
![](https://cooooing.github.io/images/设计模式/image-20200211130313251.png)
...
![](https://cooooing.github.io/images/设计模式/命令模式.png)
...
![](https://cooooing.github.io/images/设计模式/责任链模式.png)
...
例：通过按钮来控制一个电梯的状态，一个电梯有开门状态，关门状态，停止状态，运行状态。每一种状态改变，都有可能要根据其他状态来更新处理。
例如，如果电梯门现在处于运行时状态，就不能进行开门操作，而如果电梯门是停止状态，就可以执行开门操作。

类图如下：

![](https://cooooing.github.io/images/设计模式/状态模式前.png)
...
![](https://cooooing.github.io/images/设计模式/状态模式.png)
...
使用观察者模式来模拟这样的场景，微信用户就是观察者，微信公众号是被观察者，有多个的微信用户关注了程序猿这个公众号。

类图如下：

![](https://cooooing.github.io/images/设计模式/观察者模式.png)7
...
例如在下左图中，有六个同事类对象，假如对象1发生变化，那么将会有4个对象受到影响。如果对象2发生变化，那么将会有5个对象受到影响。也就是说，同事类之间直接关联的设计是不好的。
...
![](https://cooooing.github.io/images/设计模式/image-20200214110924010.png)
...
类图如下：
![](https://cooooing.github.io/images/设计模式/中介者模式.png)
...
![](https://cooooing.github.io/images/设计模式/迭代器模式.png)
...
![](https://cooooing.github.io/images/设计模式/访问者模式.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200214215446638.png)
...
双分派可以实现方法的动态绑定，可以对上面的程序进行修改。

运行结果如下：

![](https://cooooing.github.io/images/设计模式/image-20200426233931693.png)
...
![](https://cooooing.github.io/images/设计模式/白箱备忘录模式.png)
...
这样 `GameRole` 类看到的是 `RoleStateMemento` 所有的接口，而`RoleStateCaretaker`  及其他对象看到的仅仅是标识接口 `Memento` 所暴露出来的接口，从而维护了封装型。
类图如下：

![](https://cooooing.github.io/images/设计模式/黑箱备忘录模式.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200215220322641.png)
...
![](https://cooooing.github.io/images/设计模式/image-20200215225227616.png)
...
![](https://cooooing.github.io/images/设计模式/解释器模式.png)
...
~~目前为止最长且花得时间最久的，不想总结了。~~

设计模式算是了解了一遍，具体的还得在以后的写代码的过程中慢慢深入体会。
以后看一些框架源码应该会更加轻松一些吧。（也许）
