...
![各角色需要掌握的知识要点.png](https://cooooing.github.io/images/《收获，不止Oracle》读书笔记上篇-开始和物理体系/各角色需要掌握的知识要点.png)
...
![Oracle体系结构图.png](https://cooooing.github.io/images/《收获，不止Oracle》读书笔记上篇-开始和物理体系/Oracle体系结构图.png)
...
![PROC1在共享池中的执行情况.png](https://cooooing.github.io/images/《收获，不止Oracle》读书笔记上篇-开始和物理体系/PROC1在共享池中的执行情况.png)
...
![PROC2在共享池中的执行情况.png](https://cooooing.github.io/images/《收获，不止Oracle》读书笔记上篇-开始和物理体系/PROC2在共享池中的执行情况.png)
...
一般来说，静态SQL会自动使用绑定变量
![PROC3在共享池中的执行情况.png](https://cooooing.github.io/images/《收获，不止Oracle》读书笔记上篇-开始和物理体系/PROC3在共享池中的执行情况.png)
