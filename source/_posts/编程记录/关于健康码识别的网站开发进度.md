...
目前进度：确认大体需求
![大体需求.png](https://cooooing.github.io/images/编程记录/关于健康码识别的网站开发进度记录/大体需求.png)
> 2022-05-21  
> 周六，楼下的广场舞很吵。
...
目前进度：创建数据库，搭建项目基本配置
![img.png](https://cooooing.github.io/images/编程记录/关于健康码识别的网站开发进度记录/数据库er图.png)
> 2022-07-05  
